...
public class UsersDaoJdbcTemplateImpl implements UsersDao {
    ...
    private final String SQL_SELECT_USER_WITH_CARS =
            "SELECT user_table.*, car_table.id as car_id, car_table.model FROM user_table LEFT JOIN car_table ON user_table.id = car_table.owner_id WHERE user_table.id = ?";

    private final String SQL_SELECT_USERS_WITH_CARS =
            "SELECT user_table.*, car_table.id as car_id, car_table.model FROM user_table LEFT JOIN car_table ON user_table.id = car_table.owner_id";

    private final String SQL_SELECT_ALL_BY_FIRST_NAME =
            "SELECT * FROM user_table WHERE first_name = ?";
    ...
    private final String SQL_INSERT_USER = "" +
            "INSERT INTO user_table(first_name, last_name) VALUES (:firstName, :lastName)";
